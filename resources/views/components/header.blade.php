    ...
    <div class="flex items-center gap-3">
        @if (Request::is('transaction/create'))
            <a href="{{ route('transaction.index') }}"
                class="bg-yellow-400 hover:bg-yellow-600 px-6 py-2 h-max text-white rounded-xl">
                History
        ...
        <div class="relative inline-block text-left">
            <button onclick="toggleModal()"
                class="flex items-center justify-center w-10 h-10 bg-white border-none rounded-full focus:outline-none">
                <img id="user-avatar" src="" alt="Avatar" class="w-10 h-10 rounded-full">
            </button>
        </div>
            ...
            <div class="bg-white w-72 rounded-lg shadow-lg p-6 absolute top-4 right-4 text-left">
                ...
                <div class="mt-4 flex justify-center">
                    ...
                    <a href="{{ route('user.settings') }}"
                        class="bg-gray-300 hover:bg-blue-500 hover:text-white text-gray-700 py-2 px-4 rounded-lg flex items-center justify-center w-full text-center">
                        <svg class="mr-2" fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1"
